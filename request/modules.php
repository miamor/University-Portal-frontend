...
$ar = array();
$ar['page'] = array('gioi-thieu');

$ar['modules'] = array(

  array('link' => 'gioi-thieu', 'text' => 'Giới thiệu'),

  // những modules trong page gioi-thieu
  //'gioi-thieu' => array(
    array('link' => 'gioi-thieu-chung', 'parent' => 'gioi-thieu', 'text' => 'Giới thiệu chung', 'content' => "<h3>Lịch sử phát triển</h3>
